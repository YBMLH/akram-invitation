          ...
          <div className="border border-beige-deep/45 bg-ivory p-2 shadow-[0_35px_80px_-45px_rgba(30,22,12,0.7)] sm:p-3">
            <div className="border border-beige-deep/30">
              ...
              <div className="flex flex-col items-center gap-5 px-6 py-7 text-center sm:flex-row sm:justify-between sm:text-start">
                <div>
                  <p className="font-body text-sm font-light text-taupe">
                    {ui.location.kicker}
                  </p>
                ...
                <a
                  ...
                  className="inline-flex items-center border border-ink bg-ink px-8 py-3.5 font-body text-sm font-light text-ivory transition-colors duration-500 hover:bg-transparent hover:text-ink"
                >
